...
public class Student extends Human {
	...
	public Student(String name, String surName, String middleName, int age, boolean sex, String faculty,
			String formOfStudy) {
	...
	public Student(String name, String middleName, String surName, int age, boolean sex) {
	...
	public boolean equals(Object obj) {
		...
		if ((this.getMiddleName() == null) ? (other.getMiddleName() != null)
		...
		if ((this.getFaculty() == null) ? (other.getFaculty() != null)
				: !this.getFaculty().equals(other.getFaculty())) {
			return false;
		}
